...
export const dataOptions = {
  poverty_data : {
    title: 'Poverty Rates',
    desc: 'This includes county data on the number of people living in a household with a total cash income below the U.S. Census Bureau’s poverty threshold.ext about poverty rates and the data and possibly the next year.',
  ...
  insecurity_data : {
    ...
    desc: 'This includes data on the overall food insecurity rates for people in the county. Food insecurity is defined as a lack of consistent access to enough food for an active, healthy life.t about food insecurity rates and the data and possibly the next year.',
    toggleSelect: ['Total', 'Children'],
