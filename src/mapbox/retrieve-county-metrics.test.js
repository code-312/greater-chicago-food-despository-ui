...
//NOTE: DO:
/*
  1. Incoprorate json data into test2
  2. Control using extradatamenu
  3. Test the getCountyAndMetricDictionary function
  */
  ...
  const tools = reduxRender(<App />, {
    initialState: {
      illinois_counties: require("../fetched_data/countyLayer.json"),
        county_data: { countyData: require("../fetched_data/countyData.json")},
